...
const (
	EmailService_SendEmailVerification_FullMethodName = "/email.service.frontend.email_service.v2.EmailService/SendEmailVerification"
)
...
func (c *emailServiceClient) SendEmailVerification(ctx context.Context, in *SendEmailVerificationRequest, opts ...grpc.CallOption) (*SendEmailVerificationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendEmailVerificationResponse)
	err := c.cc.Invoke(ctx, EmailService_SendEmailVerification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedEmailServiceServer) SendEmailVerification(context.Context, *SendEmailVerificationRequest) (*SendEmailVerificationResponse, error) {
...
func _EmailService_SendEmailVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmailService_SendEmailVerification_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServiceServer).SendEmailVerification(ctx, req.(*SendEmailVerificationRequest))
	}
...
var EmailService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "email.service.frontend.email_service.v2.EmailService",
	...
	Metadata: "service/frontend/email_service/v2/email_service.proto",
}
